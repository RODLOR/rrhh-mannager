...
import employees from "../assets/customers.svg"
import dashboard from "../assets/dashboard.svg"
import attendance from "../assets/loans.svg"
                ...
                <div className="flex gap-2.5 items-center">
                    <div className="relative flex">
                        <img
                            ...
                            alt="User"
                            className="rounded-md w-8 bg-slate-300"
                            src={profilePhoto}
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                >
                                    <img className={`${isActive("/employees") ? " bg-green-500 " : "bg-gray-500 "} 
                            ...
                            <div
                                ...
                                <Link
                                    ...
                                    duration-300 hover:bg-gray-200 dark:hover:bg-slate-700`}
                                >
                                    <img className={`${isActive("/attendance") ? " bg-green-500 " : "bg-gray-500 "} 
